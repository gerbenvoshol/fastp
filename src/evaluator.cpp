...
bool Evaluator::isTwoColorSystem() {
    ...
    // NOVASEQ 6000: @A0
    // NOVASEQ X PLUS: @LH
    if(starts_with(r->mName, "@NS") || starts_with(r->mName, "@NB") || starts_with(r->mName, "@NDX") || starts_with(r->mName, "@VL") || starts_with(r->mName, "@VH") || starts_with(r->mName, "@A0") || starts_with(r->mName, "@LH")) {
        delete r;
        return true;
    }
